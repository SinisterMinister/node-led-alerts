...
dangerIcon.src = fs.readFileSync(__dirname+'/../../images/images/exclamation-circle_ff0000_20.png');

var infoIcon = new Canvas.Image();
infoIcon.src = fs.readFileSync(__dirname+'/../../images/images/info-circle_0000ff_20.png');

var successIcon = new Canvas.Image();
successIcon.src = fs.readFileSync(__dirname+'/../../images/images/check-circle_008000_20.png');
